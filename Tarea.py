...
def pretty_print(logger, serializer_function=lambda obj: obj.dict):
    def decorator(func):
...
class StringWrapper(object):
    ...
    def init(self, value, case_sensitive=False, default_similarity_threshold=DEFAULT_THRESHOLD):
